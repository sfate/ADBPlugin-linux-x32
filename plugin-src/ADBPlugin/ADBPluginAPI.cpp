...
{
    std::string result = shell("echo '000Chost:devices' | telnet localhost 5037 2>/dev/null");
...
{
    std::string result = adb("forward\\ tcp:" + port + "\\ localabstract:chrome_devtools_remote");
